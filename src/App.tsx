...
function makeQuestion<T extends { name: string }>(index: number, list: T[]) {
  ...
  const options = [...pool.map(get), get(answer)].sort(() => Math.random() - 0.5);
